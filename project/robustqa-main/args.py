...
def get_train_test_args():
    ...
    #parser.add_argument('--train-datasets', type=str, default='squad')
    ...
    #parser.add_argument('--eval-datasets', type=str, default='duorc')
    parser.add_argument('--do-train', action='store_true')
    parser.add_argument('--do-eval', action='store_true')
    parser.add_argument('--sub-file', type=str, default='')
    parser.add_argument('--append-log', type=str, default='')
